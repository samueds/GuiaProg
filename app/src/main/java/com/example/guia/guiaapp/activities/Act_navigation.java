    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_Minhaconta) {
            ...
            manager.beginTransaction().replace(
                    R.id.constraitlayout_for_fragment,
                    accountFragment,
                    accountFragment.getTag()
            ).commit();

        } else if (id == R.id.nav_Meuprogresso) {

            Progress_Fragment progressFragment = new Progress_Fragment();
            FragmentManager manager = getSupportFragmentManager();
            manager.beginTransaction().replace(
                    R.id.constraitlayout_for_fragment,
                    progressFragment,
            ...
            Suport_Fragment suportFragment = new Suport_Fragment();
            FragmentManager manager = getSupportFragmentManager();
            manager.beginTransaction().replace(
                    R.id.constraitlayout_for_fragment,
                    suportFragment,
                    suportFragment.getTag()
            ).commit();

        } else if (id == R.id.nav_Logout) {
            Intent itlogout = new Intent(Act_navigation.this, Act_log.class);
